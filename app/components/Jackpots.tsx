...
const Jackpots: React.FC = ({ jackpots }) => {
	return (
		<div className='bg-slate-100 pt-5'>
			<div className=' flex flex-col items-center justify-center'>
				...
				<p className='text-center text-sm text-slate-600'>
					We bring a persolan and effective every project we
					work on. <br />
					which is why our client love why they keep coming
					back.
				</p>
			</div>
...
const Jackpot: React.FC = ({ jackpot }) => {
	return (
			...
			<div className='flex justify-start items-center space-x-2'>
				...
				<div>
					...
					<p className='text-sm text-gray-500'>
						Draws On: {jackpot.drawsAt.toDateString()}
					</p>
				</div>
			</div>
			<div className='py-5'>
				<p className='font-semibold pb-2 text-green-300'>
					{jackpot.title}
				</p>
